...
-- gethui() lebih aman di beberapa executor, PlayerGui tetap fallback utama.
...
local oldGui = GuiParent and GuiParent:FindFirstChild(OLD_GUI_NAME)
if oldGui then
    oldGui:Destroy()
end
...
--// Sebelumnya tombol ini baru muncul setelah klik "RUSHEX BUTTON: SHOW" di Menu 4.
Defer(function()
